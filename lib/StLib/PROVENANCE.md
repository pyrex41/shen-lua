...
These are the **Shen sources** of the Shen standard library for the S42
(2026-08-25 refresh) kernel. Tarver's refresh no longer ships the standard
...
- **Mirror**: `pyrex41/shen-upstream` — the designated mirror of Mark Tarver's
  shenlanguage.org uploads (private repo).
