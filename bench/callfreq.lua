...
-- Wraps every F-table entry with a call counter, runs the full 41.1 suite,
...
assert(ffi.C.chdir("../cl-source/ShenOSKernel-41.1/tests") == 0, "chdir failed")

-- 41.1 compat seeding (mirror run-41.1-tests.lua)
do
